...
''' Чи коректно описане завдання? Оскільки, якщо виконувати все згідно опису, то пошук через словник відбувається значно швидше, але якщо змінити структуру дерева і взяти в якості ключа значення ціни, то пошук відбудеться швидше за допомогою дерева.'''
